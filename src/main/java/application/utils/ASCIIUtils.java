...
public class ASCIIUtils {
    ...
    public static void print(String text, ASCIIArtSize size) {
        ASCIIUtils gen = new ASCIIUtils();
        try {
            gen.printTextArt(text, size.value);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    public static void print(String text, ASCIIArtSize size, ASCIIArtFont font, String symbol) {
        ASCIIUtils gen = new ASCIIUtils();
        try {
            gen.printTextArt(text, size.value, font, symbol);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
